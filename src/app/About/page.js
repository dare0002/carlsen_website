  ...
  return (
    <main className="max-w-4xl mt-20 mx-auto">
      <div className="mb-16 text-center space-y-2 max-w-md mx-auto">
        ...
        <p className="text-base">Carlsen er en del af Egmont, som er Danmarks største mediekoncern. Egmont er en dansk fond, som hvert år giver 100 millioner kroner til børn og unge, der har det svært. </p>
      ...
      <div className="mb-12 text-center space-y-2">
        ...
        <p className="max-w-md mx-auto text-center mb-2 text-base">Er du interesseret i at udvikle et undervisningsforløb til en af vores bøger? Send os en mail med navn, erhverv og hvilken bog du godt kunne tænke dig at arbejde med.</p>
        <Link href="/Contact">
